        ...
        try {
            ...
            rvMsg.setAdapter(new MyAdapter(lista, new RecyclerViewOnItemClickListener() {
                ...
                public void onClick(View v, int position) {
                    Toast.makeText(MainActivity2.this, "Click al evento ",Toast.LENGTH_SHORT).show();

                }

                @Override
                public void onClickEdit(View v, int position) {
                    Toast.makeText(MainActivity2.this, "Editar: "+ position,Toast.LENGTH_SHORT).show();

                }

                @Override
                public void onClickDel(View v, int position) {
                    Toast.makeText(MainActivity2.this, "Eliminar: " + position, Toast.LENGTH_SHORT).show();
